...
struct Command commands[] =
{
		...
		{"schedPRIRR", "Switch & initialize the scheduler to PRIORITY RR with given #priorities, quantum and starvation threshold", command_sched_init_PRIRR, 3},
		//**************************************//
...
int command_sched_init_PRIRR(int number_of_arguments, char**arguments)
{
	...
	int32 quantum = strtol(arguments[2], NULL, 10);
